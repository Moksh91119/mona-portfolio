...
export const portfolio = [
  {
    ...
    description: `Nov. 9, 2023-Blue-Green Rhapsody featured in the Curated Gift Guide under “Art for Nature Lover”
    
    Visiting lakes or beaches, walking along a meandering river or through verdant fields, nature provides an abundance of inspiration. In this new piece the artist captures the energy and tranquility of these experiences with the dominant colors of blues and greens.
    
    The artwork is rolled and shipped in a tube. A local professional framer can stretch the painting on gallery stretcher bars which will enable the painting to be hung without a frame.
    
    Images in-situ may not be to scale. A certificate of authenticity accompanies all paintings. Painting is signed on lower right.

    Please note: the overall size of the canvas is 83 x 62. The final size once stretched will be 79 x 58.`,
    yearCreated: "2023",
    subject: "Landscape",
    styles:
      "Abstract, Abstract Expressionism, Contemporary, Expressionism, Modernism",
